...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-background relative overflow-hidden">
      ...
      {/* Spotlight Effect */}
      <div 
        className="absolute inset-0 spotlight-effect transition-all duration-100 ease-out pointer-events-none"
        style={{
          '--x': `${mousePosition.x}%`,
          '--y': `${mousePosition.y}%`,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Story Content */}
        <div className="text-center mb-16 space-y-6 animate-slide-in-up" style={{ animationDelay: '200ms' }}>
        ...
        {/* Animated Statistics */}
        <div className="flex justify-center items-center space-x-8 mb-16 animate-slide-in-up" style={{ animationDelay: '400ms' }}>
        ...
        {/* Film Strip Timeline */}
        <div className="mb-16 animate-slide-in-up" style={{ animationDelay: '600ms' }}>
          <FilmStripTimeline />
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center space-x-6 counter-display px-8 py-4 rounded-lg">
            <div className="text-center">
              <div className="text-xs text-accent/60 font-mono">ISO</div>
              <div className="text-sm font-bold">400</div>
            </div>
            <div className="text-center">
              <div className="text-xs text-accent/60 font-mono">F</div>
              <div className="text-sm font-bold">2.8</div>
            </div>
            <div className="text-center">
              <div className="text-xs text-accent/60 font-mono">1/</div>
              <div className="text-sm font-bold">125</div>
            </div>
            <div className="text-center">
              <div className="text-xs text-accent/60 font-mono">MODE</div>
