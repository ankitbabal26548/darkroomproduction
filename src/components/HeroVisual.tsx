        ...
        >
          {loadedImages[index] && (
            <>
              ...
              {/* Floating Elements */}
              <div className="absolute top-1/4 right-1/4 w-16 h-16 bg-white/10 backdrop-blur-sm rounded-2xl rotate-12 animate-float-slow hidden lg:block" />
              <div className="absolute bottom-1/3 right-1/6 w-12 h-12 bg-accent/20 backdrop-blur-sm rounded-full animate-pulse-slow hidden lg:block" />
            </>
          )}
        </div>
      ))}
