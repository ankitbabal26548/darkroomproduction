    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {contactMethods.map((method, index) => {
          ...
          const props = method.link ? { href: method.link, target: '_blank', rel: 'noopener noreferrer' } : {};
          ...
          <div className="grid grid-cols-3 gap-4">
            {socialLinks.map((social, index) => (
              <a
                ...
                className="group text-center space-y-2 p-3 rounded-lg bg-muted/30 hover:bg-muted/50 transition-all duration-300"
              >
