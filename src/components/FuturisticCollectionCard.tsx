  ...
  return (
    ...
    >
      ...
      <div className="control-tower-v3">
        ...
        {/* Enhanced All Images Text - Creative and Informative */}
      ...
      {/* Category Badge - Desktop Only, Bottom Positioned */}
      <div className="category-badge-bottom hidden md:block">
