    ...
    <div className="relative">
      ...
      >
        ...
        <div className="control-tower-v3">
          ...
          {/* Enhanced All Images Text - Creative Display */}
      ...
      {/* Desktop-Only Category Badge - Positioned Outside Card */}
      <div className="hidden md:block category-badge-desktop">
        <div className="category-badge-content">
          <span className="category-label">Category</span>
          <span className="category-value">{collection.category}</span>
        </div>
      </div>
    </div>
  );
