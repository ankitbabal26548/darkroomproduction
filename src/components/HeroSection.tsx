        ...
        <div className="lg:col-span-5 flex flex-col justify-center px-4 sm:px-6 lg:px-12 xl:px-16 py-16 lg:py-0 my-[30px]">
          <div className={`space-y-6 lg:space-y-8 max-w-full ${isLoaded ? 'animate-slide-in-left' : 'opacity-0'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 max-w-full">
              <Button size="lg" className="group bg-accent hover:bg-accent/90 text-accent-foreground font-medium px-6 sm:px-8 py-4 sm:py-6 rounded-lg transition-all duration-300 hover:scale-105 text-sm sm:text-base">
                View Our Work
                <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button variant="outline" size="lg" className="group border-2 border-foreground/20 hover:border-accent hover:text-accent font-medium px-6 sm:px-8 py-4 sm:py-6 rounded-lg transition-all duration-300 text-sm sm:text-base">
