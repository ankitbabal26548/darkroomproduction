  ...
  return (
    <div className={`photo-carousel-3d relative w-full h-[600px] sm:h-[700px] lg:h-[800px] ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`}
      ...
      <button
        ...
        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-[250] p-3 sm:p-4 bg-background/30 hover:bg-background/50 active:bg-background/60 disabled:opacity-50 disabled:cursor-not-allowed border border-accent/30 hover:border-accent/50 rounded-full backdrop-blur-sm transition-all duration-300 touch-manipulation"
      ...
      <button
        onClick={handleNext}
        disabled={isTransitioning}
        className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-[250] p-3 sm:p-4 bg-background/30 hover:bg-background/50 active:bg-background/60 disabled:opacity-50 disabled:cursor-not-allowed border border-accent/30 hover:border-accent/50 rounded-full backdrop-blur-sm transition-all duration-300 touch-manipulation"
        style={{ minWidth: '48px', minHeight: '48px' }}
      >
